            ...
            <div className="p-6 text-gray-900">
              <div className="grid gap-1 grid-cols-2 mt-2">
                <div>
                  ...
                  <div className="mt-4">
                    <label htmlFor="UserStatus" className="font-bold text-lg ">
                      User Status
                    </label>
                    <p className="mt-1">
                      <span
                  ...
                  <div className="mt-4">
                    <label htmlFor="UserDueDate" className="font-bold text-lg">
                      Due Date
                    </label>
              ...
              <div className="mt-4">
                <label htmlFor="font-bold text-lg">User Description</label>
